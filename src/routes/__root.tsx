...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Honey Badger Outfits — Premium Men's Track Pants" },
      {
        name: "description",
        content:
    ...
    links: [
      ...
      { rel: "icon", href: "https://honeybadger-move-elevated.lovable.app/favicon.png", type: "image/png" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Men's clothing brand focused on comfortable, functional and modern everyday wear.",
        }),
      },
    ],
  }),
